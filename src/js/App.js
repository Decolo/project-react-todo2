...
class App extends Component {
    constructor(props) {
        super(props)
            // console.log(AvModule.getCurrentUser())                                     
        this.state = {
            user: AvModule.getCurrentUser() || {}, //AvModule.getCurrentUser()返回缓存的user或者是null
            newTodo: '',
    ...
    componentWillMount() {
        ...
        AvModule.getDataForMount(success)
    }
    render() {
        ...
        return (<div className="App">
                    <div className="first-row">
                        ...
                        <i className="iconfont icon-dengchu"></i></a> 
                        : 
                        null
                        } 
                    </div>
                    ...
                    <div className="input-todo">
                        ...
                        <a href="#" onClick={this.showTodoInput.bind(this)}>Add</a>
                        :
                        null
                        }
                        {
...
addTodo(e) {
        ...
        AvModule.updataData(this.state.todoList)
    }
    /*------删--------*/
delete(e, todo) {
        todo.deleted = true
